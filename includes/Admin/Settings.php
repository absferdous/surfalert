 ...
 */
class Settings extends LibSettings
{
    /**
    ...
    public function init()
    {
        ...
        add_filter('sa_branding_url', array($this, 'sa_branding_url'), 12);
        add_filter('sa_rest_miscellaneous', array($this, 'miscellaneous'), 10, 2);
    }
    ...
    {
        add_submenu_page('sa-admin', 'Settings', 'Settings', 'edit_surfalert_settings', 'sa-settings', [Admin::get_instance(), 'views'], 3);
    }
    ...
    {
        $data     = SurfAlert::get_instance()->normalize($this->settings_form());
        $settings = apply_filters('sa_settings_page_settings', $this->get('settings', []));
    ...
    {
        include_once SURFALERT_INCLUDES . 'Admin/views/settings.views.php';
    }


    public function settings_form($sa_id = 0)
    {
        do_action('sa_before_settings_fields');
        ...
        $settings  = [
            ...
            'submit'        => [
                'show'  => true,
                'label' => __('Save Settings', 'surfalert'),
                'class' => 'save-settings',
            ],
            'tabs'          => apply_filters(
                'sa_settings_tab',
                [
                    'tab-general'                => apply_filters(
                        'sa_settings_tab_general',
                        [
                            'id'       => 'tab-general',
                            'label'    => __('General', 'surfalert'),
                            'classes'  => 'tab-general',
                            'priority' => 10,
                            'fields'   => [
                                'section-modules' => [
                                    'label'  => __('Modules', 'surfalert'),
                    ...
                    'advanced-settings-tab'      => apply_filters(
                        'sa_settings_tab_advanced',
                        [
                            'id'       => 'tab-advanced-settings',
                            'label'    => __('Advanced Settings', 'surfalert'),
                            ...
                            'fields'   => [
                                'advanced-general' => [
                                    ...
                                    'fields'   => array(
                                        'enable_rest_api' => [
                                            ...
                                            'type'     => 'checkbox',
                                            'label'    => __('Enable REST API', 'surfalert'),
                                            'default'  => false,
                                            'priority' => 10,
                                            'description' => __('Forcefully enable anonymous REST API for SurfAlert.', 'surfalert'),
                                        ],
                                        'omit_credentials' => [
                                            'name'        => "omit_credentials",
                                            'type'        => 'checkbox',
                                            'label'       => __('Exclude Credentials', 'surfalert'),
                                            'default'     => true,
                                            'priority'    => 15,
                                            'description' => __('Enabling it will remove cookies, HTTP authentication entries, and TLS client certificates from API calls on the frontend.', 'surfalert'),
                                            'help'        => __('Note: Recommended if you use any caching plugins.', 'surfalert'),
                                        ],
                                        'notification_image_size' => [
                                            'name'    => "notification_image_size",
                                            'type'    => 'select',
                                            'label'   => __('Image Size', 'surfalert'),
                                            'default' => '100_100',
                                            'options' => GlobalFields::get_instance()->normalize_fields([
                                                '100_100' => __('100 x 100 px', 'surfalert'),
                                                '200_200' => __('200 x 200 px', 'surfalert'),
                                                '300_300' => __('300 x 300 px', 'surfalert'),
                                                '400_400' => __('400 x 400 px', 'surfalert'),
                                                '500_500' => __('500 x 500 px', 'surfalert'),
                                            ]),
                                            'priority' => 20,
                                            'help'     => __('Select the size for your notification image.', 'surfalert'),
                                        ],
                                        'custom_notification_import_limit' => [
                                            'name'    => "custom_notification_import_limit",
                                            'type'    => 'number',
                                            'label'   => __('Custom Notification Import Limit', 'surfalert'),
                                            'default' => 100,
                                            'priority' => 25,
                                        ],
                                    ),
                                ...
                                'powered_by'      => [
                                    'name'     => 'powered_by',
                                    'label'    => __('Powered By', 'surfalert'),
                                    'type'     => 'section',
                                    'priority' => 15,
                                    'fields'   => [
                                        'disable_powered_by' => [
                                            'type'        => 'checkbox',
                                            'label'       => __('Disable Powered By', 'surfalert'),
                                ...
                                'role_management' => array(
                                    ...
                                    'type'     => 'section',
                                    'label'    => __('Role Management', 'surfalert'),
                                    'priority' => 30,
                                    'fields'   => array(
                                        'notification_view_roles' => array(
                                            'name'     => 'notification_view_roles',
                                            'type'     => 'select',
                                            'label'    => __('Who Can View Notification?', 'surfalert'),
                                            'priority' => 1,
                                            'multiple' => true,
                                            'is_pro'   => true,
                                            'disable'  => true,
                                        ...
                                        'notification_roles'      => array(
                                            ...
                                            'type'     => 'select',
                                            'label'    => __('Who Can Create Notification?', 'surfalert'),
                                            'priority' => 1,
                                            'multiple' => true,
                                            'is_pro'   => true,
                                            'disable'  => true,
                                        ...
                                        'settings_roles'          => array(
                                            'name'     => 'settings_roles',
                                            'type'     => 'select',
                                            'label'    => __('Who Can Edit Settings?', 'surfalert'),
                                            'priority' => 2,
                                            'multiple' => true,
                                            'is_pro'   => true,
                                            'disable'  => true,
                                        ...
                                        'analytics_roles'         => array(
                                            ...
                                            'type'     => 'select',
                                            'label'    => __('Who Can Check Analytics?', 'surfalert'),
                                            'priority' => 3,
                                            'multiple' => true,
                                            'is_pro'   => true,
                                            'disable'  => true,
                    ...
                    'email-analytics-reporting'  => apply_filters(
                        'sa_settings_tab_email_analytics',
                        [
                            'label'    => __('Analytics & Reporting', 'surfalert'),
                            ...
                            'fields'   => [
                                'analytics'       => array(
                                    ...
                                    'fields'   => array(
                                        'enable_analytics'         => array(
                                            ...
                                            'type'     => 'checkbox',
                                            'label'    => __('Enable Analytics', 'surfalert'),
                                            'default'  => true,
                                            'priority' => 0,
                                        ),
                                        'disable_dashboard_widget' => array(
                                            ...
                                            'type'        => 'checkbox',
                                            'label'       => __('Disable Dashboard Widget', 'surfalert'),
                                            'default'     => false,
                                            'priority'    => 5,
                                            'description' => __('Click, if you want to disable dashboard widget of analytics only.', 'surfalert'),
                                            'rules'       => Rules::is('enable_analytics', true),
                                        ),
                                        'analytics_from'           => array(
                                            'name'     => 'analytics_from',
                                            'type'     => 'select',
                                            'label'    => __('Analytics From', 'surfalert'),
                                            'options'  => GlobalFields::get_instance()->normalize_fields(
                                                array(
                                                    'everyone'         => __('Everyone', 'surfalert'),
                                                    'guests'           => __('Guests Only', 'surfalert'),
                                                    'registered_users' => __('Registered Users Only', 'surfalert'),
                                                )
                                            ),
                                            'default'  => 'everyone',
                                            'priority' => 10,
                                        ...
                                        'exclude_bot_analytics'    => array(
                                            ...
                                            'type'        => 'checkbox',
                                            'label'       => __('Exclude Bot Analytics', 'surfalert'),
                                            'default'     => true,
                                            'priority'    => 15,
                                            'description' => __('Select if you want to exclude bot analytics.', 'surfalert'),
                                            'rules'       => Rules::is('enable_analytics', true),
                                        ),
                                    ),
                                ),
                                'email_reporting' => array(
                                    ...
                                    'priority' => 20,
                                    'type'     => 'section',
                                    'label'    => __('Reporting', 'surfalert'),
                                    'rules'    => Rules::is('enable_analytics', true),
                                    'fields'   => array(
                                        'disable_reporting'   => array(
                                            'name'     => 'disable_reporting',
                                            'label'    => __('Disable Reporting', 'surfalert'),
                                            'type'     => 'checkbox',
                                            'priority' => 0,
                                            'default'  => 0,
                                        ),
                                        'reporting_frequency' => array(
                                            ...
                                            'type'     => 'select',
                                            'label'    => __('Reporting Frequency', 'surfalert'),
                                            'default'  => 'sa_weekly',
                                            'is_pro'   => true,
                                            'priority' => 1,
                                            'disable'  => true,
                                            'options'  => GlobalFields::get_instance()->normalize_fields(
                                                array(
                                                    'sa_daily'   => __('Once Daily', 'surfalert'),
                                                    'sa_weekly'  => __('Once Weekly', 'surfalert'),
                                                    'sa_monthly' => __('Once Monthly', 'surfalert'),
                                                )
                                            ),
                                        ...
                                        'reporting_monthly_help_text' => array(
                                            ...
                                            'class'    => 'sa-warning',
                                            'priority' => 1.5,
                                            'message'  => __('It will be triggered on the first day of next month.', 'surfalert'),
                                            'rules'    => Rules::is('reporting_frequency', 'sa_monthly'),
                                        ),
                                        'reporting_day'       => array(
                                            'name'        => 'reporting_day',
                                            'type'        => 'select',
                                            'label'       => __('Select Reporting Day', 'surfalert'),
                                            'default'     => 'monday',
                                            'priority'    => 2,
                                            'options'     => GlobalFields::get_instance()->normalize_fields(
                                                array(
                                            ...
                                            'description' => __('Select a day for email report.', 'surfalert'),
                                            'rules'       => Rules::logicalRule(
                                                [
                                                    Rules::is('reporting_frequency', 'sa_weekly'),
                                        ...
                                        'reporting_email'     => array(
                                            ...
                                            'type'     => 'text',
                                            'label'    => __('Reporting Email', 'surfalert'),
                                        ...
                                        'reporting_subject'   => array(
                                            ...
                                            'type'     => 'text',
                                            'label'    => __('Reporting Email Subject', 'surfalert'),
                                            'default'  => __("Weekly Engagement Summary of ‘{$site_name}’", 'surfalert'),
                                            'priority' => 4,
                                            'disable'  => true,
                                            'rules'    => Rules::is('disable_reporting', false),
                                        ),
                                        'test_report'         => array(
                                            'name'     => 'test_report',
                                            'label'    => __('Reporting Test', 'surfalert'),
                                            'text'     => __('Test Report', 'surfalert'),
                                            'type'     => 'button',
                                            'priority' => 5,
                                            'rules'    => Rules::is('disable_reporting', false),
                                            'ajax'     => [
                                                'on'   => 'click',
                                                'api'  => '/surfalert/v1/reporting-test',
                                                'data' => [
                                                ...
                                                'swal' => [
                                                    'text'      => __('Successfully Sent a Test Report in Your Email.', 'surfalert'),
                                                    'icon'      => 'success',
                                                    'autoClose' => 2000,
                                                ],
                                            ],
                    ...
                    'cache_settings_tab'         => apply_filters(
                        'sa_settings_tab_cache',
                        [
                            'id'       => 'tab-cache-settings',
                            'label'    => __('Cache Settings', 'surfalert'),
                            'priority' => 40,
                            'fields'   => [
                                'cache_settings' => array(
                                    ...
                                    'fields'   => array(
                                        'cache_limit'            => array(
                                            'name'        => 'cache_limit',
                                            'type'        => 'text',
                                            'label'       => __('Cache Limit', 'surfalert'),
                                            'description' => __('Number of Notification Data to be saved in Database.', 'surfalert'),
                                            'default'     => '100',
                                            'priority'    => 1,
                                        ),
                                        'download_stats_cache_duration' => array(
                                            ...
                                            'type'        => 'text',
                                            'label'       => __('Download Stats Cache Duration', 'surfalert'),
                                            'description' => __('Minutes (Schedule Duration to fetch new data).', 'surfalert'),
                                            'default'     => 3,
                                            'priority'    => 2,
                                        ),
                                        'reviews_cache_duration' => array(
                                            ...
                                            'type'        => 'text',
                                            'label'       => __('Reviews Cache Duration', 'surfalert'),
                                            'description' => __('Minutes (Schedule Duration to fetch new data).', 'surfalert'),
                                            'default'     => '3',
                                            'priority'    => 3,
                                        ),
                    ...
                    'tab-miscellaneous-settings' => apply_filters(
                        'sa_settings_tab_miscellaneous',
                        [
                            'id'       => 'tab-miscellaneous-settings',
                            'label'    => __('Miscellaneous', 'surfalert'),
                            'priority' => 50,
                            'fields'   => [],
                        ]
                    ),
        ...
        if (defined('NX_DEBUG') && NX_DEBUG) {
            $settings['tabs']['tab-miscellaneous-settings']['fields'][] = array(
                'name'     => 'danger-zone',
                'type'     => 'section',
                'label'    => __('Danger Zone', 'surfalert'),
                'priority' => 200,
                'fields'   => array(
                    'delete-settings' => array(
                        'name'     => 'delete-settings',
                        'label'    => __('Delete Settings', 'surfalert'),
                        'text'     => __('Delete Settings', 'surfalert'),
                        'type'     => 'button',
                        'priority' => 15,
                        'ajax'     => [
                            'on'     => 'click',
                            'reload' => true,
                            'api'    => '/surfalert/v1/settings',
                            'data'   => [
                                'delete_settings' => true,
                            ],
                            'swal'   => [
                                'text'      => __('Successfully deleted Settings.', 'surfalert'),
                                'icon'      => 'deleted',
                                'autoClose' => 2000,
                            ],
                        ],
                    ...
                    'delete-transient' => array(
                        ...
                        'label'    => __('Delete Transient', 'surfalert'),
                        'text'     => __('Delete Transient', 'surfalert'),
                        'type'     => 'button',
                        'priority' => 25,
                        'ajax'     => [
                            'on'     => 'click',
                            'reload' => true,
                            'api'    => '/surfalert/v1/miscellaneous',
                            'data'   => [
                                'delete_transient' => true,
                            ],
                            'swal'   => [
                                'text'      => __('Successfully deleted Transient.', 'surfalert'),
                                'icon'      => 'deleted',
                                'autoClose' => 2000,
                            ],
                        ],
        ...
        $settings = apply_filters('sa_settings_configs', $settings);
        return $settings;
    }
    ...
    public function allow_admin($allcaps, $caps, $args, $user)
    {
        ...
        if (! empty($caps[0]) && array_key_exists('administrator', $allcaps) && ! array_key_exists($caps[0], $allcaps) && in_array($caps[0], $sa_roles)) {
    ...
    {
        if (! current_user_can('edit_surfalert_settings')) {
            return false;
        }
        $remove_before_save = [
            'empty',
        ...
        $settings = apply_filters('sa_settings', $settings);
        ...
        delete_transient('sa_get_field_names');
        do_action('sa_settings_saved', $settings);
        return true;
    }
    ...
    public function sa_branding_url($link)
    {
    ...
    public function get_defaults($key = null)
    {
        if (empty($this->defaults)) {
            ...
            $this->defaults = SurfAlert::get_instance()->get_field_names($tabs['tabs']);
        }
