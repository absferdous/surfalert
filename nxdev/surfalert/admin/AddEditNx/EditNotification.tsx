...
const EditNotification = (props) => {
    ...
    return (
        <BuilderProvider value={builder}>
            <div>
                <Header addNew={true} />
                {isUpdated === "saved" && !isLoading && (
                    <Notice
                        message={__("Successfully Updated.", "surfalert")}
                    />
                )}
                {isUpdated === "published" && !isLoading && (
                    <Notice
                        message={__("Successfully Created.", "surfalert")}
                    />
                )}
...
export default withDocumentTitle(EditNotification, __("Edit", "surfalert"));
