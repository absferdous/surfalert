...
const EditNx = (props) => {
    const { setIsLoading, setIsDelete, id, title, setTitle, setIsUpdated } =
        props;
    ...
    function applyDependencyClasses(builderContext) {
        ...
        builderContext.tabs.forEach((tab) => {
            ...
            tab.fields.forEach((field) => {
                ...
                const fieldValue =
                    builderContext.getFieldValue?.(dependencyName);
    ...
    return (
        <>
            <Content>
                <input
                    className="widefat sa-title"
                    type="text"
                    name="title"
                    id="sa-title"
                    placeholder={__("Surfalert Title", "surfalert")}
                    value={title}
