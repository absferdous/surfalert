        ...
        <div>
            ...
            {builderContext?.is_pro_active && (
                <WrapperWithLoader isLoading={isLoading} div={false}>
                    ...
                    />
                    <div className="sa-analytics-graph-wrapper">
            ...
            {!builderContext?.is_pro_active && (
                <div
                    className="analytics-display-area sa-stats-tease"
                    data-swal="true"
                >
                    <img
                        src={`${builderContext.assets.public}image/reports/graph.png`}
                        alt={__("Analytics Data", "surfalert")}
                    />
                    <div className="sa-stats-pro-tease">
                        <a
                            href="https://surfalert.com/#pricing"
                            target="_blank"
                        >
                            <p>{__("Get PRO to Unlock", "surfalert")}</p>
                        </a>
                    </div>
                </div>
            )}
...
export default withDocumentTitle(Analytics, __("Analytics", "surfalert"));
