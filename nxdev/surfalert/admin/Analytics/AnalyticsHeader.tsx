...
const AnalyticsHeader = ({ assetsURL }) => {
    ...
    return (
        <div className="sa-analytics-counter-wrapper">
            <AnalyticsCard
                type="views"
                icon={`${assetsURL.admin}images/analytics/views-icon.png`}
                title={__("Total Views", "surfalert")}
            ...
            <AnalyticsCard
                ...
                title={__("Total Clicks", "surfalert")}
            ...
            <AnalyticsCard
                ...
                title={__("Click-Through-Rate", "surfalert")}
                count={analytics?.totalCtr + "%"}
                url=""
                is_pro={is_pro}
            />
        </div>
