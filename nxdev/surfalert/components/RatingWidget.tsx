...
const RatingWidget = () => {
    ...
    return (
        <div className="surfalert-rating-widget sidebar-widget sa-widget">
            {!isSharedFeedback && (
                <div className="sa-widget-title-wrapper">
                    <div className="sa-widget-title">
                        {!ratingSubmitted && (
                            <Fragment>
                                {!rating && (
                                    <h4>{__("Rate SurfAlert", "surfalert")}</h4>
                                )}
                                {!rating && (
                                    <div className="sa-widget-rating-area">
                                        {[...Array(5)].map((_, index) => {
                                ...
                                {rating && rating < 5 && (
                                    <div className="sa-widget-review-box">
                                        <h4>
                                            {__(
                                        ...
                                        <div className="review-box">
                                            <label htmlFor="review-box-desc">
                                                {__(
                                                    "Please share what went wrong with The SurfAlert so that we can improve further",
                                                    "surfalert"
                                                )}
                                                <span>*</span>
                                            </label>
                        ...
                        {ratingSubmitted && (
                            <div className="review-submitted-box">
                                <h5 className={rating === 5 ? "five-star" : ""}>
                                    {rating === 5
                                        ? __(
                                              "We’re glad that you liked us! 😍",
                                              "surfalert"
                                          )
                                        : __("We appreciate it!", "surfalert")}
                                </h5>
                                <p>
                                    {rating === 5
                                        ? __(
                                              "If you don’t mind, could you take 30 seconds to review us on WordPress? Your feedback will help us improve and grow. Thank you in advance! 🙏",
                                              "surfalert"
                                          )
                                        : __(
                                              "A heartfelt gratitude for managing the time to share your thoughts with us",
                                              "surfalert"
                                          )}
                                </p>
                                {rating === 5 && (
                                    <a
                                        href="https://wordpress.org/support/plugin/surfalert/reviews/#new-post"
                                        target="_blank"
                                    >
                                        {__("Rate the Plugin", "surfalert")}
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            width="16"
                                            height="17"
                                        ...
                                        >
                                            <path
                                                d="M6 3.63175L10 8.29842L6 12.9651"
                                                stroke="#6A4BFF"
                                                stroke-width="1.5"
            ...
            <div className="sa-widget-initiate-chat">
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="32"
                    height="33"
                    ...
                    <defs>
                        ...
                        <clipPath id="clip0_4156_3185">
                            <rect
                                ...
                                height="18"
                                fill="white"
                                transform="translate(7 7.29846)"
                            />
                        </clipPath>
                    </defs>
                </svg>
                <h5>{__("Need help? We're here", "surfalert")}</h5>
                <p>
                    {__(
