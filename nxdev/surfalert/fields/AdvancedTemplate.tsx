...
const AdvancedTemplate = (props) => {
    ...
    useEffect(() => {
        ...
        if (!builderContext.savedValues?.["advanced_template"]) {
            ...
            if (
                theme == "page_analytics_pa-theme-two" ||
                theme == "page_analytics_pa-theme-one"
            ) {
                const fifth =
                    values["notification-template"].ga_fifth_param?.trim();
                const sixth = values[
                    "notification-template"
                ].sixth_param?.replace("tag_", "");
            ...
            const tmpl: any = applyFilters("nx_adv_template_default", values);
        ...
        <>
            ...
            {props?.sales_count_themes?.includes(
                ...
                <div className="template-example">
                    <span className="advance-template-label">
                        Example: {` `}
                    </span>
                    <code>{`{{title}} {{7days}}`}</code>
                    <span className="advance-template-doc">{` or `}</span>
                    <code>{`{{title}} in last {{day:7}}`}</code>
                    <span className="advance-template-doc">
                        . For more information check out this{" "}
                        <a
                            href="https://surfalert.com/docs/surfalert-advanced-template/"
                            target="_blank"
                        >
                            doc
                        </a>
            ...
            {(builderContext.values.themes == "page_analytics_pa-theme-one" ||
                builderContext.values.themes ==
                        ...
                        if (
                            ...
                            const isElForm =
                                builderContext.values.source ===
                                    "elementor_form" && tag.includes("el_");
