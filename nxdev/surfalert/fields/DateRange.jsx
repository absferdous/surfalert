...
/**
 * DateRange component for SurfAlert
...
const DateRangePicker = (props) => {
    ...
    return (
        <div
            ref={dateRangeRef}
            className={`wprf-control wprf-control-daterange ${className} ${
                disabled ? "disabled" : ""
            }`}
        >
            {/* Date Range Summary/Trigger */}
            <div className="wprf-daterange-summary" onClick={toggleDatePicker}>
            ...
            {isOpen && (
                <div
                    className={`wprf-daterange-dropdown ${
                        showPresets ? "with-presets" : ""
                    }`}
                >
                    <DateRange
