...
const IconPicker = (props) => {
    ...
    const [localValue, setLocalValue] = useState(
        getLocalValue(value, iconPrefix)
    );
    ...
    const onToolTipClickOutside = useCallback(
        (event) => {
            if (iconRef?.current) {
    ...
    useEffect(() => {
        if (typeof window !== "undefined" && !window.wp?.media) {
            console.warn(
                "WordPress media library is not available. Make sure wp-media-utils is properly loaded."
            );
        }
    }, []);
        ...
        >
            {label && (
                <div className="wprf-control-label">
                    ...
                    {description && (
                        <p className="wprf-control-description">
                            {description}
                        </p>
                    )}
                </div>
            ...
            <div className="wprf-icon-picker-wrapper">
                <span className="sa-image-popup-wrapper" ref={iconRef}>
                    {localValue ? (
                        <>
                            {value == "none" ? (
                                            ...
                                            <img
                                                ...
                                                onClick={() => {
                                                    try {
                                                        ...
                                                        console.warn(
                                                            "MediaUpload failed, trying native modal:",
                                                            error
                                                        );
