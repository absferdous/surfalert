...
const PreviewModal = (props) => {
    ...
    const onAfterOpen = () => {
        ...
        postToIframe(url, "post", iframe.name, nxPreview);
    };
    ...
    return (
        <>
            ...
            <ReactModal
                ...
                overlayClassName={`sa-template-preview`}
                style={{
                    overlay: {
                        position: "fixed",
                        display: "flex",
            ...
            >
                <>
                    <div className="sa-admin-modal-head">
                        <button
                            className={`sa-admin-modal-preview-button ${
                        ...
                        <button
                            className="sa-admin-modal-close-button"
                            type="button"
                    ...
                    <div className="sa-admin-modal-body">
                        {("inline" === context.values.type &&
                            !props.urls?.[context.values.source]) ||
                        ("woocommerce_sales_inline" === context.values.source &&
                            !props.urls?.[context.values.source]) ? (
                            <div
                                style={{
                                    height: "600px",
