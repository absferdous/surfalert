...
const ChangeCustomNotificationTime = ({
    handleChangeTime,
    setChangeTimeToggle,
}) => {
        ...
        <div className="wprf-change-time-wrapper">
            <div className="wprf-change-time-header">
                <div className="wprf-change-time-header-content">
                    <h4>{__("Change Time", "surfalert")}</h4>
                    <span>
                        {__(
                            "This will effect on all selected Items",
                            "surfalert"
                        )}
                    </span>
                </div>
            ...
            <div className="wprf-change-time-bottom">
                <button
                    className="wprf-change-time-apply-change-btn"
                    disabled={applyDisabled}
                    onClick={() => handleChangeTime(startDate, endDate)}
                >
                    {__("Apply Changes", "surfalert")}
                </button>
            </div>
        </div>
    );
