...
const AccordionItem = ({
    ...
    <div className="nx_gdpr-cookies-list-main-item">
        <div className="nx_gdpr-cookies-list-header">
            <div
                className="nx_gdpr-cookies-list-header-title"
            ...
            {cookiesList?.length > 0 && (
                <div className="nx_gdpr-cookies-list-header-active">
                    {isAlwaysActive ? (
                        <span>
                            {settings.cookie_list_active_label
                                ? settings.cookie_list_active_label
                                : __("Enabled", "surfalert")}
                        </span>
                    ) : (
        ...
        {isCollapsed && settings?.cookie_list_show_banner && (
            <div className="nx_gdpr-cookies-list-wrapper">
                {cookiesList?.map((cookie, index) => (
                    <div
                        className="nx_gdpr-cookies-list-wrapper-item"
                        key={index}
                    >
                        <div className="nx_gdpr-cookies-list-wrapper-item-value">
                            <span>{__("Cookie", "surfalert")}</span>
                            <p>{cookie?.cookies_id}</p>
                        </div>
                        <div className="nx_gdpr-cookies-list-wrapper-item-value">
                            <span>{__("Description", "surfalert")}</span>
                            <p>{cookie?.description}</p>
                        </div>
                    </div>
                ))}
                {(!cookiesList || !cookiesList?.length) && (
                    <span>{settings?.cookie_list_no_cookies_label}</span>
                )}
            </div>
        )}
    </div>
    ...
    const accordionItems = [
        {
            key: "necessary",
            title:
                settings?.necessary_tab_title ||
                notificationxPublicValue?.necessary_tab_info?.title,
            description:
                settings?.necessary_tab_desc ||
                notificationxPublicValue?.necessary_tab_info?.desc,
            isAlwaysActive: true,
        ...
        },
        {
            key: "functional",
            title:
                settings?.functional_tab_title ||
                notificationxPublicValue?.functional_tab_info?.title,
            description:
                settings?.functional_tab_desc ||
                notificationxPublicValue?.functional_tab_info?.desc,
        ...
        },
        {
            key: "analytics",
            title:
                settings?.analytics_tab_title ||
                notificationxPublicValue?.analytics_tab_info?.title,
            description:
                settings?.analytics_tab_desc ||
                notificationxPublicValue?.analytics_tab_info?.desc,
            isAlwaysActive: false,
        ...
        },
        {
            key: "performance",
            title:
                settings?.performance_tab_title ||
                notificationxPublicValue?.performance_tab_info?.title,
            description:
                settings?.performance_tab_desc ||
                notificationxPublicValue?.performance_tab_info?.desc,
            isAlwaysActive: false,
        ...
        },
        {
            key: "advertising",
            title:
                settings?.advertising_tab_title ||
                notificationxPublicValue?.advertising_tab_info?.title,
            description:
                settings?.advertising_tab_desc ||
                notificationxPublicValue?.advertising_tab_info?.desc,
            isAlwaysActive: false,
        ...
        },
        {
            key: "uncategorized",
            title:
                settings?.uncategorized_tab_title ||
                notificationxPublicValue?.uncategorized_tab_info?.title,
            description:
                settings?.uncategorized_tab_desc ||
                notificationxPublicValue?.uncategorized_tab_info?.desc,
            isAlwaysActive: false,
