...
NotificationXContext.displayName =
...
export default function useNotificationXContext() {
    ...
    invariant(
        !!notificationXContext,
        __(
            `NotificationXContext context is undefined, please verify you are calling useNotificationXContext() as child of a <SurfAlert> component.`,
            "surfalert"
        )
    );
